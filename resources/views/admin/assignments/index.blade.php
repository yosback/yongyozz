                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($assignments as $assignment)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $assignment->due_date->format('M d, Y H:i') }}</td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="{{ route('admin.assignments.edit', $assignment->id) }}" class="text-indigo-600 hover:text-indigo-900 mr-3">Edit</a>
